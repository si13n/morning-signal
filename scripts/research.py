...
if __name__ == "__main__":
    ...
    digest = create_digest(candidates, load_interests(root), date.today().isoformat(), config["model"], config["max_digest_items"], config["max_web_searches"], config["min_digest_items"], config["max_output_tokens"])
    print(digest)
